...
function BlogPage() {
    return (
        <>
            <div className="image max-w-[100vw] h-[25rem] mx-5 my-3 md:h-[35rem]"></div>
            <div className="wrp flex flex-col md:items-center">
                <section className="section-3 flex flex-col gap-3 w-[100vw] md:w-[70vw]">
                    <span className="text-4xl font-bold text-center leading-[3.5rem] m-3">
                        The World’s Most Dangerous Technology Ever Made.
                    </span>
                    <span className="flex flex-col gap-3 text-center text-gray-500">
                        <p>Ralph Hawkins . May 7, 2019 (10 mins read)</p>
                        <p>#technology #tech #career</p>
                    </span>
                    <span className="flex flex-col gap-6 m-5 text-xl">
                        <p>
